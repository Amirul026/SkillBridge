          ...
          {loading
            ...
            : courses.map(course => {
                ...
                return (
                  ...
                  >
                    {course.picture && ( // Use course.picture and add conditional rendering
                      <img
                        src={course.picture} // Use course.picture
                        alt={course.title}
                    ...
                    <div className="p-4">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-4`}>
                        by {course.mentor_name} {/* Use mentor_name */}
                      </p>
                      <div className="flex items-center gap-2 mb-3">
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                            {course.length_in_weeks} weeks {/* Use length_in_weeks */}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Users size={16} className={isDarkMode ? 'text-gray-400' : 'text-gray-600'} />
                          <span className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                            {course.lesson_number} lessons {/* Use lesson_number */}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
