          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="hidden md:flex md:w-1/2 bg-[#1e1a53] p-8 flex-col justify-center items-center text-white">
              <div className="relative w-full h-full flex flex-col items-center justify-center">
                ...
                <p className="text-center text-lg mb-12 text-blue-100">Continue your learning journey with us</p>
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12">
              <div className="max-w-md mx-auto">
                <h2 className={`text-3xl font-bold mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}>Login to Your Account</h2>
                <p className={`mb-8 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Please enter your credentials to continue</p>
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative">
                      ...
                      <input
                        ...
                        id="email"
                        required
                        className={`block w-full pl-10 rounded-lg shadow-sm ${isDarkMode ? "bg-gray-700 border-gray-600 text-white focus:border-blue-500" : "bg-gray-200 border-gray-300 focus:border-blue-500"} px-3 py-3 focus:outline-none focus:ring-1 focus:ring-blue-500`}
